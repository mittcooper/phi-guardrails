...
self-contained brief — a work order plus the constitution. Execute exactly that
brief and nothing else; every rule you are bound by is inside it. Do not seek
context beyond it.
